...
// az deployment group create --resource-group rg-bicep-townhall --template-file .\2_Variables.bicep
// az deployment group create --resource-group rg-bicep-townhall --template-file .\2_Variables.bicep --parameters prefix=townhall
